...
public class UserDAOImpl implements UserDAO {
    ...
    public List<User> getAllUsers() {
        try {
            ...
            throw new DatabaseException(CANNOT_GET_ALL_USERS);
        }
    }

    @Override
    public void addUser(int id, String name, String email, String password, String position) {
        try {
    ...
    @Override
    public void updateUser(int id, String name, String email, String password, String position) {
        try {
    ...
    public User getUserById(int id) {
        try {
            ...
            throw new DatabaseException(CANNOT_GET_USER);
        }
    }
}