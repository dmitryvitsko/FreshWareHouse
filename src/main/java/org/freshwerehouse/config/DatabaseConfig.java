...
public class DatabaseConfig {
  ...
  private static final String URL = "jdbc:postgresql://localhost:5439/warehouse_db?characterEncoding=UTF-8";
  private static final String USER = "config_service";
  private static final String PASSWORD = "config_service_pswd";
